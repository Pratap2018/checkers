...
export const protobufPackage = 'Pratap2018.checkers.checkers'
...
export class QueryClientImpl implements Query {
  ...
  StoredGame(request: QueryGetStoredGameRequest): Promise<QueryGetStoredGameResponse> {
    ...
    const promise = this.rpc.request('Pratap2018.checkers.checkers.Query', 'StoredGame', data)
  ...
  StoredGameAll(request: QueryAllStoredGameRequest): Promise<QueryAllStoredGameResponse> {
    ...
    const promise = this.rpc.request('Pratap2018.checkers.checkers.Query', 'StoredGameAll', data)
  ...
  NextGame(request: QueryGetNextGameRequest): Promise<QueryGetNextGameResponse> {
    ...
    const promise = this.rpc.request('Pratap2018.checkers.checkers.Query', 'NextGame', data)
